const style = {
	...
	wordInactive: "text-[18px] bg-red-500 text-white  opacity-30 font-medium bg-transparent border-[2px] mb-[8px] ml-[8px] border-black border-solid h-[32px] w-[32px] text-center",
